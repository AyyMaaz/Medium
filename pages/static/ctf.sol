...
/*
Flow:
1. Our CISO Steve will deploy the contract minting to his wallet 10000 HLB Tokens
2. Paul will transfer 100 HLB tokens to each employee
3. John, will ask to each of the employees to lock the tokens in the contract 
