...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=110995&cbuster=2002468516&cbuster=1665831710',
					origQString: 's=110995&cbuster=2002468516',
					placementId: 110995,
					x: 450,
					y: 253,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"106.0.0.0","browserVersionMajor":"106","browserVersionMinor":"0","chromeVersion":"106"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":{"0":"en","2":"la"},"googlePSI":false},
					isFpCookie: 0,
					geo: 'XX',
					dmaCode: 0,
					dynamicSetup: [],
